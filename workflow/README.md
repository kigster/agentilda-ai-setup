...
The workflow half of [agentilda](../README.md): a Ruby CLI that keeps a project's specifications, plans and pull requests joined up, and drives a team of specialist agents from a specification to a reviewed pull request.
