...
module SpecPlanBuild
  # `spec-plan-build index` — the project's plans as one browsable page.
  #
  ...
  class Index
    ...
    def project = @project ||= SpecPlanBuild.titleize(File.basename(File.dirname(tree.dir)))
    ...
    def heading
      <<~MARKDOWN
        ...
        > [!IMPORTANT]
        > **This file is auto generated.** To regenerate it, run `spec-plan-build index`.
