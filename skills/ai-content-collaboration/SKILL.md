...
1. **Participation boundaries.** Document where AI legitimately helps, where humans must own.
1. **Hybrid pattern selection.** Match the pattern to volume, voice sensitivity, time budget.
1. **Voice guidelines as prompt input.** Every AI generation includes brand voice context.
1. **Voice drift sampling.** Long pieces drift mid-way; sample throughout.
1. **Fact verification gate.** Every claim, every quote, every stat verified before publish.
1. **AI slop prevention.** Heavy human editing, strong briefs, iteration.
1. **Disclosure tiering.** Disclose when origin would change reader trust; calibrate to audience.
1. **Team calibration.** Documented policy, calibration sessions, voice library.
1. **Tool-agnostic methodology.** Workflow shape stays constant as tools change.
1. **Ethical floor.** Intellectual honesty, no fabrication, no hidden AI in trust-sensitive work.
1. **Final accountability.** The human who signs off is accountable; AI does not sign off.
