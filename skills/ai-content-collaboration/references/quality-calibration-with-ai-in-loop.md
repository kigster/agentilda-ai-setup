...
1. Each editor's assessment includes the AI-content audit dimensions: AI tells, hallucination patterns, voice drift, slop signals.
1. The team reads all assessments together.
1. Differences in interpretation surface; reconcile.
1. Output: addendum to the AI policy doc capturing the calibration consensus on AI-specific QA dimensions.
...
1. Voice anchor text was used in the prompt?
1. Mid-piece voice sample taken on long pieces?
1. Final pass in human voice for the closing?
1. Fact-accuracy gate ran with AI-hallucination patterns specifically in mind?
1. Disclosure decision made per the disclosure tier framework?
1. The piece passes the "could a competitor have shipped this with the same tools" test?
