...
1. Are the claims in this piece specific enough to verify? If no, the piece is hedging.
1. Does the piece take a position the reader will remember? If no, the piece is forgettable.
1. Did the human substantially rewrite, or is the AI draft mostly intact? If mostly intact, the piece is at slop risk.
1. Does the closing read as the writer's own voice? If no, the final pass was skipped.
1. Did the brief adhere to the 12-field discipline? If no, the failure is upstream.
