...
1. Compare each sample to the brand voice doc.
1. If start and end match brand voice while middle samples regress to generic, the piece has voice drift. Send back for revision.
