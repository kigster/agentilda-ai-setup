...
1. Agent picks the most relevant core archetype, or composes from 2 adjacent archetypes
1. Agent adapts the archetype's defaults to the brief (color tokens shift, type swaps to vertical-appropriate fonts, voice samples rewrite for the brand)
1. Agent flags adaptation choices made
