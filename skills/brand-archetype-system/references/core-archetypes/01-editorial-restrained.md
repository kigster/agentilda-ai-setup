...
1. **Color**: shift accent hue to match emotional direction. Muted teal feels rational; muted plum feels considered; muted moss feels grounded; muted slate feels institutional.
1. **Type**: IBM Plex Serif is a starting point. Substitutes that fit: GT Sectra, Tiempos, Fraunces, Source Serif.
1. **Density**: dial up or down based on audience. Developers tolerate more density; founders prefer more whitespace.
1. **Highlight color**: optional. Brands without a numeric story do not need it.
