...
1. **Palette pick**: clay-and-olive feels heritage outdoor (REI, Filson register). Charcoal-and-sand feels industrial workwear (Carhartt, Dickies register). Pick based on category position.
1. **Type weight**: heavy is non-negotiable. Light or regular weights pull the archetype toward Editorial Restrained.
1. **Voice**: avoid performed toughness ("BUILT FOR THE GRIND"). Real Rugged Utilitarian voice is matter-of-fact, not bombastic.
1. **Specification depth**: dedicate page real estate to materials, construction, warranty, repair policy. These are the trust signals.
