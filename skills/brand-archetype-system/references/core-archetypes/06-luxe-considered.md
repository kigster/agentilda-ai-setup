...
1. **Photography commitment**: this is a photography archetype before it is a type archetype. Lock photography direction first.
1. **Type weight discipline**: light weights (300 to 400) only. Bold serif display pulls the archetype toward Bold Confident.
1. **CTA restraint**: resist adding obvious buy buttons in hero positions. The archetype expects the reader to discover, not be sold to.
1. **Sans usage**: keep sans confined to UI labels and metadata. Sans body copy breaks the archetype.
