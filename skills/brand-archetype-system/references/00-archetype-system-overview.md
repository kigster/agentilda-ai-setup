...
1. **Archetype mismatch with audience**: picking an archetype because the user likes its exemplars rather than because it fits the audience.
1. **Cross-archetype tokens**: pulling a color from one archetype and type from another without considering coherence. Often produces incoherent output.
1. **Stale exemplars**: assuming a brand still exemplifies an archetype after a redesign. The archetype is durable; the brand is not.
