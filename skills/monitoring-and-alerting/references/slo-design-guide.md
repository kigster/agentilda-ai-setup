...
1. **The success criterion (what counts as "good")**
1. **The target (the percentage of events that should be "good")**
1. **The window (the time period over which to measure)**
...
1. **Look at user expectations.** What do users tolerate? For a marketing site, occasional slow pages are fine. For a payment system, they're not.
1. **Look at competitive bar.** What do similar services achieve?
1. **Pick something achievable but slightly aspirational.** If the current achievement is 99.5%, set the SLO at 99.7%. Don't jump to 99.99%.
...
1. **Latency SLO:** 99% of requests complete in under 1 second.
1. **Critical flow SLO:** 99.9% of checkout flows complete successfully.
