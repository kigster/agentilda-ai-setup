...
1. **Test against the site** (does the site meet it?)
1. **Document failures** (which pages, which elements, what's wrong)
1. **Specify the fix** (what specific change resolves it)
1. **Assign severity** (P0 critical, P1 important, P2 minor, P3 polish)
1. **Estimate effort** (small, medium, large)
