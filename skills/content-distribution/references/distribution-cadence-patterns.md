...
1. **Compare to channel-specific norms.** Are channel cadences within the engagement-rewarding range, or are they too sparse or too aggressive?
1. **Identify cadence inconsistencies.** Are there gaps where the program goes silent for weeks, then spikes? Inconsistency damages audience habit even when total volume is similar.
1. **Match cadence to capacity.** Is the program able to sustain the current cadences, or is it running unsustainably?
1. **Identify the campaign rhythm.** When were the last 3 flagship launches? Did sustaining cadence support them? Did campaigns earn outsized attention?
