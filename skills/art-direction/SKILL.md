...
1. **Develop the concept.** Premise, emotional through-line, takeaway.
1. **Build the look.** Mood references. Specific direction on style elements.
1. **Write the spec.** Production-level direction. Variants. Constraints.
1. **Brief the vendor.** In writing. Walk through it live. Allow questions.
1. **Review milestones.** Treatment review, halfway review, final review. Don't skip the early reviews; corrections compound.
1. **Approve and document.** What was produced, what's licensed for what use.
...
1. **Co-create.** In-house teams know the brand. Use their judgment. Don't over-direct.
1. **Establish review rhythm.** Daily check-ins for fast work, weekly for longer projects.

### For evaluating existing creative

1. **Score against the brief.** Did the work hit the brief? Where did it deviate?
1. **Score against the brand.** Does this look like the brand? Could this be confused with a competitor?
1. **Score against the goal.** Will this drive the intended outcome?
1. **Identify fixes.** What can be improved? What's a deal-breaker vs. acceptable?
...
1. The look (visual treatment with references)
1. The execution (specs, variants, constraints)
1. The standards (quality bar, examples of acceptable and unacceptable)
1. The logistics (timeline, milestones, budget, deliverables)
