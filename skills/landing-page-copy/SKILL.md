...
1. **Confirm the audience and objection.** Specific segment. The specific worry they bring.
1. **Mine the language.** Customer testimonials, support tickets, sales calls. Use real customer phrases.
1. **Draft the hero.** Headline, subheadline, CTA. Test 5 to 10 variations.
1. **Build the structure.** All 7 sections in order. Sections can combine for shorter pages.
1. **Draft sections.** Section by section. Don't polish until the structure is sound.
1. **Edit for friction.** Remove every word that doesn't earn its place. Landing pages do not have words to spare.
1. **Test the CTA.** Read the page aloud. By the end, is the visitor's next action obvious?
1. **Pre-publish:** check links, spell-check, mobile preview, SEO basics if SEO is a goal.
