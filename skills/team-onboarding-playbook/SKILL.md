...
1. Pre-stage accounts, hardware, and access. This is the most common day-1 failure point.
1. Assign a buddy. Tell the buddy what is expected of them.
1. Send the welcome message and the day-1 schedule before they start.
1. Run the first week with a focus on belonging and context, not output.
1. Check in daily for the first week, weekly for the first month.
1. Run formal 30/60/90 check-ins with explicit milestones.
1. After 90 days, do a retrospective: what worked, what was missing.
1. Update the playbook based on the retrospective. Onboarding is a living doc.
...
1. **Day-1 schedule**: meeting list, intros, first deliverable.
1. **First-week reading list**: 5-10 curated, annotated docs.
1. **30/60/90 milestones**: the explicit checkpoints for this role.
1. **Buddy guide**: what is expected of the onboarding partner.
1. **Manager check-in cadence**: scheduled 1:1s and milestone reviews.
1. **Retrospective template**: to fill out at 90 days for next-time improvement.
