...
1. **Structural archetype selected.** Problem-solution, narrative arc, layered argument, taxonomic survey, or comparative analysis as the spine.
1. **Lede earns the next 30 minutes.** Thesis stated, stakes set, position committed within the first 150-250 words.
1. **Section weights calibrated to argumentative load.** No section 3x another bearing similar load; throat-clearing sections cut.
1. **Density variation.** Argument-tight sections balanced with reflective or illustrative sections.
1. **Register variation.** Primary register sustained with secondary-register moments for variation.
1. **Rhythm variation.** Sentence and paragraph length varies; visual breakouts every 600-1,000 words.
1. **Mid-piece micro-thesis.** Central claim restated around the 40-60% mark.
1. **Citations match claim density.** Falsifiable claims cited; primary or authoritative sources preferred; sources fresh.
1. **Visual elements earn position.** Each chart, diagram, sidebar carries load the prose alone cannot.
1. **Closing is specific.** Specific call, reframed thesis, open question, or provocation. Not recap.
1. **Distribution shape matches format choice.** Gating, format mix, syndication plan, refresh schedule planned at piece-design time.
