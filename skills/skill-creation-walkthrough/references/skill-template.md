...
1. Replace the placeholder text in `[brackets]`.
1. Delete sections you do not need (most skills do not need every section).
1. Read the annotations to understand what each section is doing.
1. Test the skill on a real task. Iterate.
