...
**Site:** [Domain] **Pages audited:** [Sample size and selection method] **Audit date:** [YYYY-MM-DD] **Auditor:** [Name] **Tools used:** [Crawler, GSC, log analyzer, Lighthouse, schema validator, etc.]
...
1. The single biggest blocker.
1. The estimated traffic at risk if technical issues persist.
1. The recommended next move.
1. Estimated effort for the top fix.
...
Audit conducted by: [Name, date] Reviewed with: [Stakeholders] Implementation owner: [Name] Re-audit scheduled: [Date]
