...
1. Triage categorizes and weights.
1. Periodic synthesis surfaces patterns.
1. Patterns inform roadmap discussions, spec drafts, prioritization debates.
1. Decisions reference specific feedback patterns as input.
1. Decisions ship; the loop continues with new feedback informed by the changes.
