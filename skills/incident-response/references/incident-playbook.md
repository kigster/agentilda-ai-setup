...
**Acknowledgment SLA:** 5 minutes **Update cadence:** Every 15 minutes **Resolution target:** As fast as humanly possible
...
**Acknowledgment SLA:** 15 minutes **Update cadence:** Every 30 minutes **Resolution target:** Within hours
...
**Acknowledgment SLA:** 1 hour **Update cadence:** As progress dictates **Resolution target:** Within a day
...
**Acknowledgment SLA:** Next business day **Resolution target:** As prioritized
...
1. Final internal update
1. Capture initial timeline (the scribe's notes)
1. Identify obvious follow-up action items, file tickets
1. Schedule AAR within 1 to 2 weeks
1. Hand off any monitoring to normal operations
