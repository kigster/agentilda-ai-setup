...
1. **Tag at the artifact level.** First-pass descriptive tagging.
1. **Cluster across artifacts.** Group tags into themes.
1. **Name patterns.** Each cluster becomes a named pattern.
1. **Infer product implications.** What does each pattern imply.
1. **Name the so-what.** The decision input.
