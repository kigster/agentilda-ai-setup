...
1. Are multiple candidate implications surfaced where appropriate?
1. Is each implication specific enough to be falsifiable?
1. Does each implication acknowledge cost?
1. Where the data supports not-acting, is that surfaced honestly?
1. Does each implication map to a specific decision?
1. Is implication strength labeled?
