...
1. Can a reader guess the implication from the name alone?
1. Is this a truism or a specific observation?
1. Does the name commit a position with conviction?
1. Does the name match what the data actually shows (no overstatement)?
1. Could this be split into multiple patterns or merged with another?
