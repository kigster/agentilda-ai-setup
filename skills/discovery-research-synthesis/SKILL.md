...
1. **Research types matched to questions.** Interviews, support, sales calls, surveys, in-app combined deliberately.
1. **The synthesis sequence: transcribe, tag, cluster, name, imply, so-what.** No stage skipped.
1. **Tags emerge from artifacts; taxonomy not pre-designed.**
1. **Tag proliferation allowed; clustering collapses.**
1. **Patterns named with conviction; not categories or truisms.**
1. **Each pattern produces a specific falsifiable product implication.**
1. **Each implication has a so-what tied to a real decision.**
1. **Output is a document, not a deck.** Patterns lead; evidence in appendix.
1. **Synthesis is opinionated.** Hedges flagged; conviction shown.
1. **Review loop before publish.** Participants, adjacent teams, quantitative validation where available.
1. **Data gaps named, not buried.** Where research did not support a position, the synthesis says so.
