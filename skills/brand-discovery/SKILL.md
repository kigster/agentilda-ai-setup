...
1. **Audit existing inputs.** Sales calls, support tickets, reviews, analytics, internal docs. Often more is known than people think.
1. **Audience research.** 5 to 8 interviews if possible. Plus secondary research from review and forum analysis.
1. **Competitor mapping.** 3 to 8 competitors deep, including indirect and status-quo competitors.
1. **Category mapping.** Conventions, shifts, vocabulary, moats.
1. **Territory generation.** 3 to 5 plausible positioning territories.
1. **Write the discovery report.** Use the template in [`references/discovery-report-template.md`](references/discovery-report-template.md).
1. **Hand off to next phase.** Discovery feeds into `creative-brief`, `brand-ideation`, or `content-strategy` depending on where the project goes next.
...
1. Audience (1 to 3 named segments with profiles)
1. Competitors (matrix and per-competitor analysis)
1. Category and problem space
1. Positioning territories (3 to 5 candidates)
1. Implications and recommendations
1. Open questions that require further research
