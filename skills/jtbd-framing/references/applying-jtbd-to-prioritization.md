...
1. Custom report builder (Job C; high impact; high strategic weight).
1. Mobile app for task creation (Job A on mobile; medium impact; low strategic weight).
1. Sidebar redesign (no clear job; serves general usability).
1. Slack integration upgrade (Job D; medium impact; medium strategic weight).
1. Onboarding redesign (multiple jobs; high impact on hire criteria for new customers).
1. Admin role overhaul (Job D for enterprise; high impact for that segment; matches enterprise expansion strategy).
1. Migration to new search backend (technical; serves multiple jobs indirectly).
