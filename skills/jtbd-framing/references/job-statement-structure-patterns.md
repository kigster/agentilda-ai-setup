...
1. Is the motivation product-independent and goal-directed?
1. Is the outcome the user's success criterion, not a feature output?
1. Is the statement specific enough that another team could distinguish it from related jobs?
1. Could the team use this job statement to evaluate a product decision?
