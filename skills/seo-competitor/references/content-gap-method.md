...
1. Note the top 10 ranking domains for each.
1. Aggregate. Domains that appear 5+ times are search competitors, even if they are not direct.
...
1. Jira (direct, incumbent)
1. Notion (adjacent, encroaching)
1. Asana (direct, larger)
1. Height (direct, peer)
