...
1. **Pick the angles.** Run all 5 for a full audit, or 2 to 3 for a focused dive.
1. **Pull the data.** Keyword tool exports, backlink tool exports, manual SERP inspection, technical crawl.
1. **Score each angle.** Where does the user lead? Where do they trail?
1. **Identify gaps.** Specific content gaps, specific backlink gaps, specific technical gaps.
1. **Prioritize.** Which gaps are highest leverage to close? (Big traffic potential, achievable effort, strategic fit.)
1. **Write the report.** Use the template in [`references/competitive-audit-template.md`](references/competitive-audit-template.md).
...
1. Competitor profiles (one per competitor, brief)
1. SERP overlap analysis
1. Content gap analysis
1. Backlink gap analysis
1. Technical comparison
1. Brand and entity comparison
1. Prioritized gap-closing roadmap
