...
1. **Identify the priority queries.** What questions should AI cite this site for? List 10 to 20.
1. **Test current AI visibility.** Query each of the major AI products (those relevant to the audience) with the priority questions. Note which sources they cite.
1. **Identify gaps.** Is the site cited? On which queries? Why does it lose to the cited sources?
1. **Layer-by-layer plan.**
...
1. **Implement and re-test.** AI products update frequently. Re-test priority queries quarterly.
...
1. 5-layer scorecard
1. Priority queries (the 10 to 20 the site should be cited for)
1. Layer-by-layer remediation plan
1. Implementation roadmap
1. Re-test schedule (quarterly)
