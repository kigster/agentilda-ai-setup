...
1. **Use semantic structure.** Headings name the question. Lists separate items. Tables compare options. Code blocks contain code.
1. **Be self-contained.** Each section should make sense without depending on the section above.
...
> 1. Deploy to your environment: `npm run deploy`
> 1. Verify the deployment by checking the status endpoint.
...
1. Read only the bullet lists, tables, and Q&A blocks. Do they answer the obvious questions?
1. Ask an LLM (in a fresh context) the questions your page answers. Does it pull useful, accurate snippets from your page?
1. Check Google's "People also ask" for your topic. Does your page answer those exact questions?
