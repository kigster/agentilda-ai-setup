...
1. Adds the shape to this file under the appropriate section (hero or footer) with the same format the existing shapes use.
1. Commits the vocabulary addition in the build PR.
