...
1. **Translation requested** through a TMS (translation management system) or spreadsheet
1. **Translation produced** with translation memory (avoids retranslating reused phrases)
1. **Review** by a second translator or in-region staff
1. **Localization** beyond translation (currency, units, examples, cultural references)
1. **Publishing** in the destination locale
1. **Update propagation** when source content changes
