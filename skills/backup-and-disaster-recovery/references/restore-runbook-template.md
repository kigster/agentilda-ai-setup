...
**Owner team:** [Team name] **On-call escalation:** [Who, how to reach] **Last drill:** [YYYY-MM-DD] **Last verified working:** [YYYY-MM-DD]
...
**Authorization required from:** [Role] **Backup authorization from:** [Role]
...
Last test: [YYYY-MM-DD] Test cadence: [How often]
...
Last review: [YYYY-MM-DD] by [Name] Next review: [YYYY-MM-DD]
