...
1. How to decide to restore (decision criteria, who authorizes)
1. The exact restore steps (commands, screenshots, sequence)
1. How to verify the restore worked
1. How to switch traffic back
1. Communication template (status page, customer notice)
