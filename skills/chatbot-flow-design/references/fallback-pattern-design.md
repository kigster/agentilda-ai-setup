...
1. If not recognized, try clarification (Layer 1).
1. If clarification fails, suggest intents (Layer 2).
1. If suggestions fail, offer resources (Layer 3).
1. If resources do not match, escalate (Layer 4).
