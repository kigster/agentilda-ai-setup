...
1. Feature inquiry (sub-intents: specific feature, comparison to competitor, roadmap question)
1. Integration question (sub-intents: specific integration, API question, custom integration)
1. Demo request (sub-intents: standard demo, enterprise demo, technical deep-dive)
1. Support escalation (sub-intents: bug report, account issue, billing problem, general help)
1. Account access (sub-intents: password reset, account login, organization-level access)
1. General overview (sub-intent: introductory tour)
