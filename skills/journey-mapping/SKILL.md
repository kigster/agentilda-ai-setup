...
1. **Gather inputs.** User interviews, internal interviews, operational data. Plan 2 to 4 weeks for inputs.
1. **Draft the journey.** Phases, steps, touchpoints. Get to a working draft fast; iterate.
1. **Add the layers.** Goals, thoughts, emotions, pain points.
1. **Build the service blueprint.** Front-stage, back-stage, supporting processes.
1. **Identify opportunities.** Use the friction points and disconnects.
1. **Validate with users.** Does this match their actual experience? Refine.
1. **Workshop with stakeholders.** Walk teams through the map. Ensure shared understanding.
1. **Translate to action.** Specific projects, owners, timelines.
1. **Maintain.** A journey map is a living document. Revisit annually or after major changes.
...
1. **Service blueprint** (visual, typically same tool)
1. **Opportunity map** (markdown, prioritized list)
