...
1. **Hold blank.** A simple page or DNS NXDOMAIN. Acceptable for domains you may use later.
1. **Park with a landing page.** Generic "coming soon" page. Lowest value. Avoid registrar default parking pages (often serve ads against your brand).
