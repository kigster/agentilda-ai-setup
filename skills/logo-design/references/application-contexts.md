...
1. **28px app icon.** Does the mark work inside rounded-square or circle masks?
1. **1.5 inch embroidery patch.** Can the mark be embroidered with 4-6 colors and chunky strokes?
1. **Single-color reproduction.** Does the mark read in pure black on white?
1. **Reverse on dark.** Does the mark hold up inverted on a dark background?
1. **Large-format signage.** Does the mark survive scaling to 12 feet?
1. **Motion lockup.** Does the mark have a natural entry and exit animation?
1. **Social profile picture.** Does the mark work inside a circle mask at 80px?
1. **Apparel embroidery.** Does the mark survive thread on fabric?
1. **Foil stamp.** Does the mark survive single-color metallic impression?
