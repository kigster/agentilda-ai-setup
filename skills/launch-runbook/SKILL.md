...
1. Run final database migrations (if applicable)
1. Deploy code to production
1. Verify deploy completed without errors
1. Run smoke tests on production
1. DNS cutover (if applicable)
1. Verify DNS propagation
1. Disable maintenance mode
1. Run full smoke tests on production
1. Announce launch to internal team
1. Begin monitoring window
...
1. **Test the rollback procedure.** Untested rollback is hope, not procedure.
1. **Run a tabletop exercise.** Walk through the runbook with the full team. Find gaps.
1. **Lower DNS TTL** 48 to 72 hours before launch (if DNS change is part of launch).
1. **Day-of:** Run the runbook step by step. Verify each step before moving to next.
1. **Monitor.** First hour, first day, first week. Document anything noteworthy.
1. **Schedule the AAR** within 1 to 2 weeks of launch.
...
1. Pre-launch checklist (T-30, T-7, T-1, T-1hr)
1. Cutover sequence (numbered steps, owners, verifications)
1. Rollback procedure
1. Rollback criteria (automatic and discretionary)
1. Communication plan
1. Verification checklist (first hour, first day)
1. Stabilization plan (first week)
1. Contacts (escalation paths, on-call)
