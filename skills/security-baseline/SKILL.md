...
1. Set up a violation report endpoint.
1. Watch for legitimate violations (third-party scripts, inline handlers).
1. Tune the policy.
1. Switch to enforcing mode once violations are mostly false positives.
1. Continue monitoring violation reports for new issues.
