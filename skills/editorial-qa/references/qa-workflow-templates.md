...
1. **Fact-accuracy.** Second. Halt-condition; AI hallucinations do not progress past this gate.
1. **Structure and clarity.** Third. Identifies pieces that need structural revision before voice and SEO checks make sense.
1. **AI-content audit.** Fourth. Catches AI tells, hallucinations not caught at gate 2, voice drift.
1. **Voice consistency.** Fifth. Mid-piece sampling for long pieces.
1. **SEO and AEO compliance.** Sixth. Most failures here are auto-fixable; rarely halt-conditions.
1. **Internal linking and schema validation.** Seventh. Mostly auto-fix or flag.
1. **Final read.** The last full read before publish. Catches anything the gate-by-gate review missed.
