...
1. **Test budget produced a new winner.** A test channel or audience is hitting CAC equal to or better than baseline. Promote it to baseline at 15% of total budget; the previous baseline holds 55 to 60%.
1. **Frequency exceeded threshold across the prospecting audience.** The audience saw the creative more than the cap. Either rotate creative or expand the audience; if both are constrained, pull back budget.
