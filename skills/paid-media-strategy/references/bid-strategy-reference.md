...
1. **Volatile conversion volume.** If conversion volume is bouncing 50%+ week-over-week, the platform's optimization signal is noisy. Stabilize volume before switching.
1. **Active creative test.** If you are mid-test on creative or audience, do not also change bid strategy. One variable at a time. The bid strategy change muddies the creative test signal.
