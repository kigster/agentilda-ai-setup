...
1. **Topic has natural facets.** You can identify 8 to 15 distinct subtopics that could each be their own piece. If you can only think of 3, it is probably a cluster, not a pillar.
1. **Commercial relevance.** The topic connects to your business model. A pillar without commercial signal is content marketing for content marketing's sake.
1. **Competitive feasibility.** Top 10 SERP for the pillar keyword is achievable. If the SERP is dominated by Wikipedia, government sites, and Fortune 500 brands, your pillar will rank position 47 no matter how good it is.
1. **Editorial commitment.** The team will maintain the pillar (refresh annually, add new clusters, update statistics). Pillars are not ship-and-forget; they are 5-year commitments.
...
1. **Cluster facets.** Each cluster piece covers one facet of the pillar topic. Facets are surfaced from keyword research (long-tail variations of pillar keyword), "people also ask" data, sub-headings in top-ranking pillar pages on the SERP, competitor cluster maps, and first-party customer questions (sales calls, support tickets).
1. **No facet duplication.** Two cluster pieces should not target overlapping queries. If they do, consolidate to one piece.
1. **Cluster heterogeneity.** Clusters should cover the topic from multiple angles (definition, how-to, comparison, examples, common mistakes, costs, alternatives, case studies) rather than 12 variations of "what is X."
1. **Sequence.** Ship pillar first (or alongside the first 3 to 5 clusters). The link graph will not form without the pillar in place; clusters that link to a non-existent pillar are orphans-in-waiting.
...
1. **Cluster size targets 10 to 12.** Sweet spot, not the maximum.
1. **Facet heterogeneity.** Definition, how-to, comparison, examples, mistakes, costs, alternatives. Not 12 variations of "what is X."
1. **No facet duplication.** Clusters cover distinct queries; consolidate when they overlap.
1. **Pillar to cluster to pillar link graph.** Top-down plus bottom-up plus selective lateral.
1. **Anchor text discipline.** Varied, descriptive, natural-language. No stuffing, no "click here."
1. **URL structure signals the hub.** `/topic/` not `/blog/`.
1. **Pillar anatomy includes TL;DR and FAQ.** Citation-ready sections for AI engines.
1. **Cluster anatomy links UP to pillar early.** First 200 words and closing.
1. **AEO/GEO and SEO together.** Two-engine optimization, complementary not competing.
1. **Annual pillar refresh plus triggered cluster refresh.** Maintenance is part of the architecture.
1. **Hub ownership is durable.** Single owner across 3 to 5 year horizons; not "the team that launched it."
