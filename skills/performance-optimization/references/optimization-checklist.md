...
1. Walk this checklist top to bottom for each page. Mark passes, gaps, and not-applicable.
1. Triage gaps into the audit report (`audit-template.md`) under Now / Next / Later.
1. Re-test after each fix lands. Performance is a moving average, not a snapshot.
