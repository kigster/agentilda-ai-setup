...
**Site / app:** [Name and URL] **Pages audited:** [List the specific URLs, not "the site"] **Audit date:** [YYYY-MM-DD] **Auditor:** [Name] **Devices and conditions tested:**

- Mobile: [Device class, network throttling]
- Desktop: [Network throttling]
- Geographies: [If multi-region tested] **Tools used:** [Lighthouse, WebPageTest, Chrome DevTools, real-user data source, etc.]
...
1. Whether the site passes Core Web Vitals at the 75th percentile.
1. The single biggest issue and what it costs.
1. The recommended next move.
1. Estimated effort and impact for the top fix.
...
**Type:** [Marketing / product / app shell / API-driven] **Traffic share:** [Rough % of site traffic] **Field metrics (if available):**
