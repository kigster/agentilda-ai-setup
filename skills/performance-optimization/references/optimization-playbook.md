...
1. Find the LCP marker
1. Note which element is the LCP (usually a hero image or large heading)
...
1. Look for long tasks (orange bars >50ms) following input events
1. Identify the function calls that take the longest
...
1. Look for "Layout Shifts" markers
1. Click each to see what shifted
...
1. Lighthouse performance score >90 on representative pages
1. Performance budgets enforced in CI
1. Periodic re-audit scheduled (quarterly minimum)
