...
1. Beta customers (opt-in). Engaged users who tolerate roughness in exchange for early access.
1. Free-tier customers. Larger population; risk to revenue is bounded because they are unpaid.
1. Paid customers, smaller plans first. Tier-by-tier escalation.
1. Paid customers, enterprise. Last; highest revenue impact, lowest tolerance for issues.
...
1. English-speaking regions (US, CA, UK, AU, NZ).
1. Western Europe (DE, FR, ES, IT, NL, etc.).
1. APAC (JP, SG, AU, etc.).
1. LATAM and remaining regions.
...
1. Internal QA confirms the timestamp is correct in the platform UI.
1. The launch hour arrives; the flag flips automatically.
1. The team monitors the same metrics as a percentage rollout but at the full population from minute one.
