...
1. **301 redirect old URLs to new.** Permanent redirect preserves SEO equity.
1. **Avoid redirect chains.** Old URL should redirect directly to the new URL, not to an intermediate.
1. **Update internal links.** Every internal link should point at the new URL, not the old.
1. **Update sitemap.** New URLs only, no legacy URLs.
1. **Wait 90+ days before removing redirects.** Search engines and external sites take time to update.
