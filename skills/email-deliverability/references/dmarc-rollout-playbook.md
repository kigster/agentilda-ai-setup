...
1. Fix the sender (add to SPF, configure DKIM, fix alignment)
1. Verify the fix in subsequent reports
1. Continue
...
1. If yes, fix the authentication for it
1. If no, this is the spoofing DMARC is meant to stop
