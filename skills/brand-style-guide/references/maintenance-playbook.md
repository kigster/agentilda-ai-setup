...
1. **Triage** by owner within 5 business days. Assigns tier.
1. **Comment / review** depending on tier.
1. **Decide.** Approve, decline (with reason), or revise.
1. **Ship.** Update the guide, update related assets, communicate.
1. **Communicate.** Announce in the brand channel. Note in the changelog.
