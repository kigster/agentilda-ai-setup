...
1. **Is engagement strong?** If engagement is below target among adopters, the value is not landing for the right reasons.
1. **Is the metric correctly attributed?** Did another concurrent change interfere with the measurement.
1. **Did the side-effects analysis catch a counterweight?** A negative side effect could be cancelling the positive primary effect.
