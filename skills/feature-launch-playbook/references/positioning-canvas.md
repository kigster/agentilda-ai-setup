...
1. **Support review.** Can support answer the obvious questions (what does it cost, how do I turn it on, what are the limits) using only the canvas?
1. **Executive review.** Does the positioning fit the company narrative? Will it confuse customers who are mid-purchase on a different feature?
