...
1. **Will customers be confused if we do not tell them?** If yes, at least Tier 2.
1. **Will the metric this is meant to move show up in board reporting?** If yes, Tier 1. If yes but only at the team level, Tier 2.
