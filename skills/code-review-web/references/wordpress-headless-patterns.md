...
**Pros:** Simple. No URL rewriting. **Cons:** Browser makes requests to a different origin. Need to allow that origin in image optimizer config.
...
1. Frontend: handle 404s on slug routes by falling back to a search-by-title
