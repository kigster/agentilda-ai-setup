...
1. Use consistent icons for service types
1. Label edges with protocols (HTTPS, TCP, etc.)
1. Use junctions for fan-out patterns
1. Keep diagrams focused; split complex architectures into multiple views
