...
module SpecPlanBuild
  module Linear
    # Linear's GraphQL API, wrapped as thinly as {SpecPlanBuild::GitHub} wraps
    ...
    class API
      ...
      # @raise [SpecPlanBuild::Error] when no team wears that key
      def team(key)
      ...
      # @raise [SpecPlanBuild::Error] on a transport or GraphQL error
