...
module SpecPlanBuild
  ...
  class Adoption
    ...
    # @!attribute [r] ordinal
    #   @return [SpecPlanBuild::Ordinal] the slot it was allocated
    # @!attribute [r] major
    ...
    # @return [Array<SpecPlanBuild::Adoption::Adoptee>] in pull request order
    def plan(pulls)
    ...
    # @return [Array<SpecPlanBuild::Adoption::Adoptee>] with `path` filled in
    def call(pulls)
      adoptees = plan(pulls)
    ...
    # @return [Integer]
    def major_for(pull)
      candidates = SpecPlanBuild.plans_on_ref(root, pull[:branch].to_s)
    ...
    def touched(pull)
      Array(pull[:files]).filter_map { |path|
        ...
        index = parts.index(SpecPlanBuild::PLANS_DIR)
    ...
    # @return [Array<SpecPlanBuild::Adoption::Adoptee>]
    ...
    # @return [SpecPlanBuild::Adoption::Adoptee]
    def adopt(adoptee)
