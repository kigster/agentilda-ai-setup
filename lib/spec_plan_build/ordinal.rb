...
module SpecPlanBuild
  ...
  class Ordinal < Data.define(:major, :minor)
    ...
    # @return [SpecPlanBuild::Ordinal, nil] nil when it is not a plan number
    def self.parse(text)
    ...
    #
    # @param existing [Array<SpecPlanBuild::Ordinal>]
    ...
    # @return [SpecPlanBuild::Ordinal]
    # @raise [SpecPlanBuild::Error] when the gap is full
