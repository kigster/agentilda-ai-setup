...
RSpec.describe SpecPlanBuild::Adoption, :tree do
  subject(:adoption) { described_class.new(tree: SpecPlanBuild::Tree.new(dir: plans_root), github:, root: plans_root) }

  let(:github) { instance_double(SpecPlanBuild::GitHub) }
  ...
  describe "#plan" do
    ...
    it "steps over minors the tree already holds rather than colliding with them" do
      ...
      fresh = described_class.new(tree: SpecPlanBuild::Tree.new(dir: plans_root), github:, root: plans_root)
    ...
    it "refuses to run past the last retroactive slot rather than wrapping" do
      ...
      fresh = described_class.new(tree: SpecPlanBuild::Tree.new(dir: crowded), github:, root: crowded)
  ...
  describe "#call" do
    ...
    it "produces folders whose contents justify the state they claim" do
      adoption.call(pulls)
      subjects = SpecPlanBuild::Tree.new(dir: plans_root).reload.subjects
