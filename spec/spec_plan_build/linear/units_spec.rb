...
RSpec.describe SpecPlanBuild::Linear::Units, :tree do
  subject(:units) { described_class.new(subject: SpecPlanBuild::Tree.new(dir: plans_root).find(ordinal)).all }
  ...
  describe "matching pull requests to units" do
    ...
    it "believes the pull request number written into the heading" do
      ...
      found = described_class.new(subject: SpecPlanBuild::Tree.new(dir: plans_root).find("020.00")).all
    ...
    it "never gives one pull request to two units" do
      ...
      found = described_class.new(subject: SpecPlanBuild::Tree.new(dir: plans_root).find("011.00")).all
