...
RSpec.describe SpecPlanBuild::Linear::Import, :tree do
  subject(:import) do
    described_class.new(tree: SpecPlanBuild::Tree.new(dir: plans_root), team: "TAX", project:, **options)
  end
  ...
  describe "deciding between create, update and skip" do
    ...
    def digest_of(unit)
      described_class.new(tree: SpecPlanBuild::Tree.new(dir: plans_root), team: "TAX", project:)
  ...
  describe "pull requests attributed to a folder from outside it" do
    ...
    let(:orphan) do
      SpecPlanBuild::PullRequest.new(number: "91", title: "Wire the rig to CI",
